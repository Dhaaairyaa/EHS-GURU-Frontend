...
const CustomButton = ({text,address}) => {
  return (
    <Link to={address} target="_blank" className=" relative inline-flex items-center px-12 py-3 overflow-hidden text-lg font-medium text-[#0a2b14] border-2 border-[#8BBE87] rounded-full hover:text-white group hover:bg-gray-50">
